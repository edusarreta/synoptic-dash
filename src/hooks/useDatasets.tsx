...
import { getDatasetsList, getDatasetsPreview } from '@/modules/datasets/api';
...
export function useDatasets(org_id?: string, workspace_id?: string) {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      return await getDatasetsList(org_id, workspace_id);
    },
    enabled: !!org_id,
...
export function useDatasetPreview(dataset_id?: string, org_id?: string, workspace_id?: string) {
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return await getDatasetsPreview(dataset_id, org_id, workspace_id);
    },
