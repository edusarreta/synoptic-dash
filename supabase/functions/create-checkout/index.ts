...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Creating checkout session", { plan_type, price: planPrices[plan_type as keyof typeof planPrices] });
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: { 
              ...
              description: `Monthly subscription to ${plan_type} plan`
            },
            unit_amount: planPrices[plan_type as keyof typeof planPrices],
