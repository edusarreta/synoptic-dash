...
-- Using correct column names based on current schema

-- 1. DATA_CONNECTIONS - Contains database credentials (highest priority)
-- This table still uses account_id
...
-- This table uses dashboard_id, so we join through dashboards
...
-- This table uses account_id but references dashboards
...
-- This table was updated to use org_id instead of account_id
